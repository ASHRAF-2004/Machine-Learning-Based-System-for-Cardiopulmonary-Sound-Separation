...
The open part is the set of concrete \texttt{SeparationAlgorithm} implementations. The closed part is \texttt{SeparationEngine}; it can keep the same call structure while a future real algorithm is added through a new strategy class and service-level selection logic.
