...
\begin{titlepage}
  ...
  \begin{minipage}{0.45\textwidth}
    \centering
    \IfFileExists{../elements/MMU_LOGO.png}{%
      \includegraphics[width=\linewidth,height=2.2cm,keepaspectratio]{../elements/MMU_LOGO.png}%
    }{%
      \fbox{MMU logo placeholder}%
    }
  \end{minipage}
  \hfill
  \begin{minipage}{0.45\textwidth}
    ...
    \IfFileExists{../elements/FCI__MMU_LOGO.png}{%
      \includegraphics[width=\linewidth,height=2.2cm,keepaspectratio]{../elements/FCI__MMU_LOGO.png}%
    }{%
